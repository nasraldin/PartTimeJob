		...
		<h2> <?php _e('Config Escrow system','boxtheme');?> </h2> <br />
	   	<div class="sub-item" id="commision">
			<form >
				...
				<div class="form-group row">
					<label for="example-text-input" class="col-md-3 col-form-label"><?php _e('Commission type','boxtheme');?></label>
					<div class="col-md-9">
				...
				<div class="form-group row">
					<label for="example-text-input" class="col-md-3 col-form-label"><?php _e('Who will pay commission','boxtheme');?></label>
					<div class="col-md-9">
			...
			<div class="row">
				...
				<div class="col-md-9" style="padding-top: 20px;">
					<select class="form-control auto-save" name="active">
						...
						<option value="paypal_adaptive" disabled <?php selected( $active,'paypal_adaptive' ) ?>><?php _e('PayPal Adaptive(No longer support)','boxtheme');?></option>
					</select>
				</div>
			</div>
		</div>
