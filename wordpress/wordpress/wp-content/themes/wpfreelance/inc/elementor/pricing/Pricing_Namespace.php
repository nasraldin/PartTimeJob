<?php
namespace BoxPricing;

use BoxPricing\Widgets\Hello_World;
use BoxPricing\Widgets\Inline_Editing;
...
class Plugin {
	...
	private function includes() {
		require BOX_ELEMENTOR_PATH . '/pricing/widgets/pricing.php';
		require BOX_ELEMENTOR_PATH . '/pricing/widgets/inline-editing.php';
	}
