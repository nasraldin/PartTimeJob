...
function btn_google_login(){
	...
	if( $gg_activate ) {
		$social_log = true;
		?><a href="#" class="btn btn-default google btn-google"><i class="fa fa-google-plus modal-icons"></i><?php _e('<span class="hidden-xs">Sign In with</span> Google','boxtheme');?><div class="g-signin2"  data-onsuccess="onSignIn"> </div></a>
