...
if( !defined ('BOX_VERSION') ){
	define('BOX_VERSION', '1.0.86.2');
}
...
include_once ( 'subscription/requires.php' );
...
function box_debug_apperances(){
	if(defined('BOX_DEBUG') && BOX_DEBUG) {

	}
}
add_action('wp_footer','box_debug_apperances');