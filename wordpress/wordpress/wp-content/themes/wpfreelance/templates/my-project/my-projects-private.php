...
<ul class="dashboard-tab   ul-list-project" id="dashboard-private">
	...
	?>
	<li class="heading heading-table list-style-none padding-bottom-10 list-projects-private.php">
	...
	if( $query-> have_posts() ){
		...
		<li class="no-result" style="padding-top: 20px; list-style:none">
			<p class="col-md-12 col-xs-12"><?php _e('There are no projects in private.','boxtheme'); ?></p>
		</li> <?php
	}
	wp_reset_query(); ?>
</ul>