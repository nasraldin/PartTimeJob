<?php
global $post, $itemsperrow, $showdes;
...
$bclass = 'archive-profile-item';
if ($itemsperrow == 2){
	$bclass = 'col-sm-6';
}
?>
<div class="shortcode-profile-item <?php echo $bclass;?>">
	<div class="full">
		...
		<div class="col-md-10 align-left  col-xs-9 res-content res-second-line no-padding-right">
			...
			<span class="inline list-info col-md-12 no-padding-right no-padding-left">
				<span class=" item hour-rate col-md-4 "> <span class="txt-rate"><?php echo $profile->{HOUR_RATE_TEXT};?> </span></span>
				<span class=" item eared-txt col-md-3 col-xs-4 text-center hide HIDDEN"><?php echo $profile->earned_txt;?> </span>
				...
				<span class="item profile-rating col-md-5 col-xs-4 no-padding-right text-right">
		...
		<div class="col-md-10 align-left  col-xs-12 res-content no-padding-right">
			...
			if( $showdes === true ){
				...
				echo wp_trim_words($post->post_content, 62);
			}
			?>

			</span>
			<small class="clear skills list-skill"><?php echo $skill_val;?></small>
		</div>
	</div>
</div>