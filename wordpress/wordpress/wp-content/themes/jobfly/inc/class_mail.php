...
Class Box_Email{
	...
	function send_mail( $to, $subject, $message, $attachment = false ){
		...
		return wp_mail( $to, $subject, $msg, $headers = '', $attachment );
...
function box_mail( $to, $subject, $message, $attachment = false ) {
	return Box_Email::get_instance()->send_mail( $to, $subject, $message, $attachment );
}
class Box_ActMail{
	static $_instance;
