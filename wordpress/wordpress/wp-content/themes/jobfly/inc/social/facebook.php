...
function btn_fb_login(){
	...
	if( $fb_activate) {	?>
		...
		<a href="#" class="btn btn-default facebook btn-facebook" onclick="shoModalLogin()"> <i class="fa fa-facebook modal-icons"></i><span class="hidden-xs"> Sign In with </span>Facebook </a><?php
	}
}
