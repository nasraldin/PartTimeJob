		...
		<div class="site-content" id="content" >
				...
				<?php
					...
					if( $profile_id ){
						...
						if( $role == FREELANCER ){
							get_template_part( 'template-profile/fre', 'edit-overview' );
							get_template_part( 'template-profile/fre', 'edit-freelancer' );
						}
					} else {
						get_template_part( 'template-profile/emp', 'edit-overview' );
					}
